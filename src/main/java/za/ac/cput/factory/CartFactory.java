...
public class CartFactory {
    public static Cart addCart(Customer customer_ID, Products products_ID, int quantity){
        double productPrice = products_ID.getProduct_Price();
